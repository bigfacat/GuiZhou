...
.btn01:hover{background-color:#00b3de;}
    ...
    function loadPage(){
        ...
        document.getElementById("iframehtm").src = href + "/setting/ybnsrzzsqcs.html" ;
    }
    function initFrame(){
	...
	$(document).ready(function(e) {
		...
		if('null'.indexOf('YBNSRZZSQCS'.toUpperCase())!=-1){
			$('.anima').css('display','');	
    	}else{
    		$('.anima').css('display','none');	
    	}
		if(''.indexOf('137')==0 && 'YBNSRZZSQCS'.toUpperCase().indexOf('CWBB')==0){
			$("#hqjdsj").hide();
			$("#cwbbchssj").show();
			if(''.indexOf('13702')==0){
...
<input type="hidden" id="bzz" value="csgj"></input>
<input type="hidden" id="ywbm" value="YBNSRZZSQCS"></input>
<input type="hidden" id="swjgDm" value=""></input>
<input type="hidden" id="djxh" value=""></input>
