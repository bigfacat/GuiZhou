...
<head>
	<script type="text/javascript">
		...
		function openWin(url){
	   	 	window.open(url+ "&nsrsbh="+'91520111MA6HA38P10'+"&_bt=chreom&_st=sm,0,800,600,培训视频");
	    }
	</script>
...
.btn06{ background-color:#2690e9; /* border:1px solid #fff; */ color:#fff; opacity:0.8}
.btn06:hover{ background-color:#fff; color:#1a56a9; opacity:1}
.btn10{ background-color:#ff9600; color:#fff; opacity:1}
.btn10:hover{ background-color:#ffba00; color:#fff; opacity:1}
.btn01:hover{background-color:#00b3de;}
    ...
    function loadPage(){
        ...
        document.getElementById("iframehtm").src = window.location.protocol +"//"+ window.location.host + pathname + "/setting/cwbbydy.html" ;
    }
    function initFrame(){
	...
	$(document).ready(function(e) {
		...
		if('null'.indexOf('CWBBYDY'.toUpperCase())!=-1){
			$('.anima').css('display','');	
    	}else{
    		$('.anima').css('display','none');	
    	}
		if('15201110300'.indexOf('137')==0 && 'CWBBYDY'.toUpperCase().indexOf('CWBB')==0){
			$("#hqjdsj").hide();
			$("#cwbbchssj").show();
			if('15201110300'.indexOf('13702')==0){
...
<input type="hidden" id="swjgDm" value="15201110300"></input>
<input type="hidden" id="djxh" value="10115201010000193737"></input>
<input type="hidden" id="sssqQ" value="2018-10-01"></input>
<input type="hidden" id="sssqZ" value="2018-10-31"></input>
<input type="hidden" id="gdslxDm" value="1"></input>
<input type="hidden" id="nsrsbh" value="91520111MA6HA38P10"></input>
<input type="hidden" id="test" value=""></input>
<input type="hidden" id="sjlybz" value=""></input>
<input type="hidden" id="kjzdzzDm" value="102"></input>
<input type="hidden" id="isycs" value=""></input>
<input type="hidden" id="cusId" value=""></input>
<input type="hidden" id="bbbsqDm" value="4"></input>
<input type="hidden" id="zlbsxlDm" value=""></input>
<input type="hidden" id="isGgUser" value="00"></input>
...
<table width="100%" height="60" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right">
    		 <div class="anima"><div class="anima-v"><a href="#" onclick="openWin('null')">基础信息培训视频</a></div></div>
