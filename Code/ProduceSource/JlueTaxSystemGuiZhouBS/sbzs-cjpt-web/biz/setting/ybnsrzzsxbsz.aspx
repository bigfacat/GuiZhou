...
<head>
	<script type="text/javascript">
		...
		function openWin(url){
	   	 	window.open(url+ "&nsrsbh="+'91520190314387738N'+"&_bt=chreom&_st=sm,0,800,600,培训视频");
	    }
	</script>
...
.btn01:hover{background-color:#00b3de;}
	...
	$(document).ready(function(e) {
		...
		if('null'.indexOf('YBNSRZZSXBSZ'.toUpperCase())!=-1){
			$('.anima').css('display','');	
    	}else{
    		$('.anima').css('display','none');	
    	}
		if(''.indexOf('137')==0 && 'YBNSRZZSXBSZ'.toUpperCase().indexOf('CWBB')==0){
			$("#hqjdsj").hide();
			$("#cwbbchssj").show();
			if(''.indexOf('13702')==0){
...
<input type="hidden" id="djxh" value="10115201000083900814"></input>
...
<input type="hidden" id="nsrsbh" value="91520190314387738N"></input>
